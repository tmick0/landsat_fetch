...
def main():
    ...
    parser.add_argument("lat0", type=float, help="Northern latitude for the bounds of the mosaic")
    parser.add_argument("lon0", type=float, help="Western longitude for the bounds of the mosaic")
    parser.add_argument("lat1", type=float, help="Southern latitude for the bounds of the mosaic")
    parser.add_argument("lon1", type=float, help="Eastern longitude for the bounds of the mosaic")
    parser.add_argument("-c", "--max_clouds", type=float, default=10, help="Maximum cloud cover of fetched products (percent)")
    parser.add_argument("-b", "--band", type=int, action='append', default=None, help="Band selection for the mosaic")
    parser.add_argument("-f", "--scene_list", type=str, default=None, help="Path to an existing scene list")
